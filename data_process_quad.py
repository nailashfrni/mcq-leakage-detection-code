...
'''
Code is modified from https://github.com/nishiwen1214/Benchmark-leakage-detection
{
...
Cmd example:
python data_process_quad.py  --data_dir data/mmlu/cpt_dataset_mmlu_Qwen2.5-0..5B.json --eval mmlu --save_dir permutation/data/mmlu --fine_tune_type cpt
python data_process_quad.py  --data_dir data/mmlu/mmlu.csv --eval mmlu --save_dir permutation/data/mmlu --num_batches 5
...
# Define options
# Use only two options for each logprob computation
permutations_list = list(itertools.permutations(chars, 2))
...
for batch_idx in range(num_batches):
    ...
    final_filename = f"{args.save_dir}/quad_permutations_data_{filename}{batch_suffix}.json"
